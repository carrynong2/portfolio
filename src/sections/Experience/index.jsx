      ...
      >
        ...
        <div className='grid gap-y-4'>
          <div className={`text-primaryAccent ${isMouseEnter.exp1 ? 'text-primaryTitle' : ''}`}>
            Fashion Ecommerce
            <FontAwesomeIcon className={`text-xs -rotate-45 duration-300 east-out ${isMouseEnter.exp1 ? 'translate-x-1 -translate-y-1' : ''}`} icon={faArrowRight} />
          </div>
          ...
          <div>
            <div className='flex gap-4 text-sm'>
              <div className={`bg-primarySubcontent px-2 py-1 rounded-md ${isMouseEnter.exp1 ? "text-primaryTitle" : ""} text-primaryTitle`}>React</div>
              <div className={`bg-primarySubcontent px-2 py-1 rounded-md ${isMouseEnter.exp1 ? "text-primaryTitle" : ""} text-primaryTitle`}>Tailwind</div>
            </div>
          </div>
        </div>
      </div>
